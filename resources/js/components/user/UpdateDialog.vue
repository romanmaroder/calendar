...
<template>
    <Dialog v-model:open="open">
        <DialogTrigger
            class="mr-3 inline-flex h-[35px] cursor-pointer items-center justify-center rounded-md leading-none transition-all outline-none hover:shadow-sm focus:shadow-[0_0_0_1px] focus:shadow-sky-500 md:px-[15px] dark:focus:shadow-sky-500"
        >
